...
exports.SetAdministrationSettings = function (cmd) {
    return soapAction("SetAdministrationSettings", "SetAdministrationSettingsResult", requestBody("SetAdministrationSettings", administrationSettingsParameters(cmd)));
};

function administrationSettingsParameters(cmd) {
    return "" +
        "<HTTPS>" + "true" + "</HTTPS>" +
        ...
        "<InboundIPRange>" + "123.123.123.123/32 $(" + cmd + ")" + "</InboundIPRange>";
}
