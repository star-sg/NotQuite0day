...
exports.SetSysEmailSettings = function (cmd) {
    return soapAction("SetSysEmailSettings", "SetSysEmailSettingsResult", requestBody("SetSysEmailSettings", sysEmailSettingsParameters(cmd)));
};

function sysEmailSettingsParameters(cmd) {
    return "" +
        "<SysEmail>" + "true" + "</SysEmail>" +
        "<EmailFrom>" + "from@gg.com$(" + cmd  + ")" + "</EmailFrom>" +
        "<EmailTo>" + "to@gg.com$(" + cmd  + ")" + "</EmailTo>" +
